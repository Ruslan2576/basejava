...
//    private static final Resume SPECAL_RESUME = ResumeTestData.createResume(SPECIAL_UUID, "Name4");
    ...
    @Test
    void update() {
        // Resume resumeTest = ResumeTestData.createResume(UUID_1, "Name");
        Resume resumeTest = new Resume(UUID_1, "Name1");
    ...
    @Test
    void updateNotExist() {
        assertThrows(NotExistStorageException.class, () -> storage.update(SPECIAL_RESUME));
    }

    @Test
    void save() {
        storage.save(SPECIAL_RESUME);
        assertGet(SPECIAL_RESUME);
